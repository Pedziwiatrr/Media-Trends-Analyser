...
const icons: Record<string, ReactNode> = {
  X: (
    <svg viewBox="" fill="" className="">
      <path d="" />
    </svg>
  ),
  Reddit: (
    <svg viewBox="0 0 24 24" fill="#FF4500" className="w-6 h-6">
  ...
  'RSS Feeds': (
    <svg viewBox="0 0 24 24" fill="#FFA500" className="w-5 h-5">
      <path d="M19.199 24C19.199 13.467 10.533 4.8 0 4.8V0c13.165 0 24 10.835 24 24h-4.801zM3.291 17.415c1.814 0 3.293 1.479 3.293 3.295 0 1.813-1.485 3.29-3.301 3.29C1.47 24 0 22.526 0 20.71s1.475-3.294 3.291-3.295zM15.909 24h-4.665c0-6.169-5.075-11.245-11.244-11.245V8.09c8.727 0 15.909 7.184 15.909 15.91z" />
    </svg>
  ),
  BBC: (
    <svg viewBox="0 0 24 24" fill="#BB1919" className="w-10 h-10">
...
export function SourceSelector({
  ...
  return (
    <button
      onClick={onChange}
      className="group flex flex-row items-center gap-3 p-2 rounded-xl transition-all duration-300 hover:bg-gray-900/50"
    >
      <div
        className={`
